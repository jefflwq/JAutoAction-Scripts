--法师-冰霜-保命
local v
v = AddSelfShield(#寒冰护体#, playerHealthPercent < 0.3 or not (player.Buff:Has("冰冷血脉") or player.Buff:Has("能量符文"))) if v then return v end
...
v = run("召水元素") if v then return v end
